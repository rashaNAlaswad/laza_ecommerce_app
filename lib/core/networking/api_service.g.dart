...
class _ApiService implements ApiService {
  ...
  @override
  Future<ProductDetailesResponse> getProductById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ProductDetailesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'products/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProductDetailesResponse _value;
    try {
      _value = ProductDetailesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
